...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_residual_mlp_workflow(self):
        ...
        self.assertTrue(
            all(layer.tensor_s.samples == 0 for layer in model._growing_layers)
        )
    ...
    def test_data_flow_between_modules(self):
        ...
        # Create modules
        layer1 = LinearGrowingModule(input_features, hidden_features, name="layer1")
        layer2 = LinearGrowingModule(
            hidden_features, output_features, previous_module=layer1, name="layer2"
        )
    ...
    def test_data_flow_between_different_containers(self):
        ...
        mlp_layer = LinearGrowingModule(input_features, hidden_features, name="mlp_layer")

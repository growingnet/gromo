...
class ClassicalResNetBasicBlock(SequentialGrowingContainer):
    def __init__(
        self,
        in_features: int = 3,
        ...
        for i in range(nb_stages):
            ...
            stage.append(
                RestrictedConv2dGrowingBlock(
                    ...
                    pre_addition_function=nn.BatchNorm2d(
                        output_channels, device=self.device
                    ),
                    ...
                    downsample=(
                        nn.Sequential(
                            ...
                            nn.BatchNorm2d(output_channels, device=self.device),
                        )
                        if i > 0
    ...
    def append_block(
        ...
        input_channels = stage[-2].out_features
        ...
        new_block = RestrictedConv2dGrowingBlock(
            ...
            extended_mid_activation=self.activation,
            pre_addition_function=nn.BatchNorm2d(output_channels, device=self.device),
...
def init_full_classical_resnet_structure(
    ...
    model = ClassicalResNetBasicBlock(
...
if __name__ == "__main__":
    ...
    model = init_full_classical_resnet_structure(
